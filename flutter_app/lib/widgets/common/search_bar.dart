...
class CustomSearchBar extends StatefulWidget implements PreferredSizeWidget {
  final AuthService authService; // AuthService Instanz hinzufügen

  const CustomSearchBar({super.key, required this.authService});
...
class _CustomSearchBarState extends State<CustomSearchBar> {
  ...
  void _logout() async {
    ...
    // Umleitung oder Aktion nach dem Logout
  }
